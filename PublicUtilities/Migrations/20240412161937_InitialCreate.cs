        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlacesOfResidence_Streets_StreetsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Indicators_PlacesOfResidence_PlacesOfResidenceId",
                        column: x => x.PlacesOfResidenceId,
                        principalTable: "PlacesOfResidence",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Indicators_Utilities_UtilitiesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPlacesOfResidence", x => new { x.AppUserId, x.PlacesOfResidenceId });
                    table.ForeignKey(
                        name: "FK_UsersPlacesOfResidence_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersPlacesOfResidence_PlacesOfResidence_PlacesOfResidenceId",
                        column: x => x.PlacesOfResidenceId,
                        principalTable: "PlacesOfResidence",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Indicators_PlacesOfResidenceId",
                table: "Indicators",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "UsersPlacesOfResidence",
                column: "PlacesOfResidenceId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersStatements_StatementsId",
                table: "UsersStatements",
                column: "StatementsId");
        }
